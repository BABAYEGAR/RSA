...
! function($) {
        ...
        GoogleChart.prototype.createLineChart = function(selector, data, axislabel, colors) {
            ...
            GoogleChart.prototype.init = function() {
                ...
                $this.createColumnChart($("#column-chart")[0],
                    column_data,
                    "Sales and Expenses",
                    ["#4bd396", "#f5707a", "#3ac9d6"]);
                ...
                $this.createColumnStackChart($("#column-stacked-chart")[0],
                    column_stacked_data,
                    "Sales and Expenses",
                    ["#188ae2", "#4bd396", "#f9c851", "#f5707a", "#6b5fb5", "#3ac9d6"]);
                ...
                $this.createBarStackChart($("#bar-stacked-chart")[0],
                    bar_stacked_data,
                    ["#188ae2", "#4bd396", "#f9c851", "#f5707a", "#6b5fb5", "#3ac9d6"]);
                ...
                $this.createPieChart($("#pie-chart")[0],
                    pie_data,
                    ["#188ae2", "#4bd396", "#f9c851", "#f5707a", "#6b5fb5"],
                    false,
                    false);


                //creating donut chart
                $this.createDonutChart($("#donut-chart")[0],
                    pie_data,
                    ["#188ae2", "#4bd396", "#f9c851", "#f5707a", "#6b5fb5"]);

                //creating 3d pie chart
                $this.createPieChart($("#pie-3d-chart")[0],
                    pie_data,
                    ["#188ae2", "#4bd396", "#f9c851", "#f5707a", "#6b5fb5"],
                    true,
                    false);
                ...
                $this.createPieChart($("#3d-exploded-chart")[0],
                    sliced_Data,
                    ["#188ae2", "#4bd396", "#f9c851", "#f5707a", "#6b5fb5"],
                    true,
                    true);
                ...
                $(window).on("resize",
                    function() {
                        $this.createLineChart($("#line-chart")[0],
                            common_data,
                            "Sales and Expenses",
                            ["#4bd396", "#f5707a"]);
                        $this.createAreaChart($("#area-chart")[0],
                            common_data,
                            "Sales and Expenses",
                            ["#4bd396", "#f5707a"]);
                        $this.createColumnChart($("#column-chart")[0],
